...
export const metadata: Metadata = { title: "Contact Stripe2QB", description: "Get help with Stripe2QB tools, imports, and conversion workflows.", alternates: { canonical: "/contact" } };
