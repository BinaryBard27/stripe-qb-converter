...
export const metadata = { title: "Stripe & QuickBooks Guides | Stripe2QB", description: "Clear, practical guides for Stripe exports, QuickBooks imports, fees, payouts, and payment operations." };
